...
# ---------------------------------------------------------------------------
for f in tests/test_agent_tools.py tests/test_approvals.py tests/test_autoapprove.py tests/test_mcp_bridge.py tests/test_db_migration.py tests/test_security.py tests/test_oidc.py tests/test_oidc_provider.py tests/test_capability_ledger.py tests/test_ci_release_gate.py tests/test_backup_restore_scripts.py tests/test_node_primitives_smoke.py tests/test_exec_attempt_decision_gate.py tests/test_execution_attempt_foundation.py tests/test_execution_launch_arbitration.py tests/test_execution_attempt_dispatch.py tests/test_canary_report.py tests/test_server_publication.py tests/test_dataset_snapshot.py tests/test_execution_plan.py tests/test_execution_plan_api.py tests/test_node_agent_daemon.py tests/test_health_endpoints.py tests/test_restore_drill.py tests/test_code_promotion.py tests/test_node_v2_lease.py; do
  if [ -f "$REPO/$f" ]; then
