...
RUNNER_METHODS = frozenset({M_HELLO, M_HEARTBEAT, M_SESSION_EVENT, M_SESSION_STATUS, M_PERMISSION_REQUEST, M_SESSION_DIFF_RESULT})
SERVER_METHODS = frozenset({M_HELLO_ACK, M_SESSION_OPEN, M_SESSION_MESSAGE, M_SESSION_INTERRUPT, M_SESSION_CLOSE, M_SESSION_DIFF, M_SESSION_CONFIGURE, M_PERMISSION_DECISION})
