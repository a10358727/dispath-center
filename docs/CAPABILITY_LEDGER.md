...
| `hardware_execution_v1` | DG-HARDWARE-EXECUTION v1 | partial | on | on | no | P1–P3 landed (devices, image registry, `hardware_action_v2`, SFTP push, receipts, known-good, physical_tools; migrations 21–24); P4 Studio pending |
