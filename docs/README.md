...
| 你要做什麼 | 先看 | 再看 |
|---|---|---|
| 理解產品是什麼、邊界在哪 | [Platform Charter](./PLATFORM_CHARTER.md) | [V0.1 Architecture](./product/V0_1_PRODUCT_ARCHITECTURE.md)、[UX Plan](./product/V0_1_UX_PLAN.md)、[Implementation Plan](./product/V0_1_IMPLEMENTATION_PLAN.md) |
...
├── product/
│   ├── README.md
│   ├── V0_1_PRODUCT_ARCHITECTURE.md ← V0.1 目標／架構
│   ├── V0_1_UX_PLAN.md               ← V0.1 UX／互動規格
│   ├── V0_1_IMPLEMENTATION_PLAN.md   ← V0.1 實作計畫／進度
│   └── ROADMAP.md            ← 未來產品方向
│
├── decisions/
│   ├── README.md
